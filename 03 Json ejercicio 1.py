...
def serializar():
    ...
    json_data = {"nombre": "Juan","apellido": "Perez","DNI": "12345678","prendas": [{"prenda": "zapatilla","cantidad": 4},{"prenda": "remeras","cantidad": 12},
        {"prenda": "pantalon","cantidad": 6}]}
...
def deserializar():
    ...
    with open ('json_data', 'r') as jsonfile:
        ...
        file = json.dumps(json_data, indent=4)
        print(file)
